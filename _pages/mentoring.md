...
## PhD
- Lina Amaya. Enhancing Autonomous Space Robotic Manipulation Through Efficient Sevomotor Skills (Supervisor), 2023-current
- Ioannis Stavropoulos. Robot Shared Autonomy Via Immersive Interfaces Under Communications and Bandwidth Constraints (Collaboration), 2023-current
- Mohatashem Reyaz. Robot Assited On-Ground Emulation of In-Orbit Interactions under Scale and Time-Delay Constraints (Supervisor), 2021-current
-	Andrej Orsula.  Reinforcement Learning for Space Manipulation (Co-supervisor), 2021-current
-	Maxime Hubert. Design of a Capturing, Absorbing, and SEcuring system for active space Debris removal (Co-supervisor), 2021-current
-	Xiao Li. Design and implementation of software in the loop architecture for active space debris removal high-fidelity scenarios, (Co-supervisor), 2021-current
-	Kuldeep Barad. Towards Generalizable Vision-Based Autonomy for On-Orbit Manipulation (Co-supervisor), 2020-Jan2025
